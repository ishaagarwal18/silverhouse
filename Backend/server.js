...
// GET /api/products - Get all products with category and images
...
app.post('/api/send/categories', async (req, res) => {
  try {
...
// POST /api/products - Add a new product (and optional image)
app.post('/api/send/products', async (req, res) => {
  try {
    const {
      product_id,
      category_id,
...
// POST /api/images - Add images for a product
